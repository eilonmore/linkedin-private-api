...
*Defined in [src/scrollers/skip-limit-scroller.ts:17](https://github.com/cosiall/linkedin-private-api/blob/4854731/src/scrollers/skip-limit-scroller.ts#L17)*
