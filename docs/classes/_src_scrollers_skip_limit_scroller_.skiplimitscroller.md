...
*Defined in [src/scrollers/skip-limit-scroller.ts:17](https://github.com/cosiall/linkedin-private-api/blob/6982069/src/scrollers/skip-limit-scroller.ts#L17)*
