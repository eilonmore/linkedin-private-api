...
*Defined in src/repositories/invitation.repository.ts:35*
...
*Defined in src/repositories/invitation.repository.ts:49*
...
*Defined in src/repositories/invitation.repository.ts:41*
...
*Defined in src/repositories/invitation.repository.ts:57*
