...
*Defined in [src/repositories/message.repository.ts:18](https://github.com/brunohafonso95/linkedin-private-api/blob/466124d/src/repositories/message.repository.ts#L18)*
...
*Defined in [src/repositories/message.repository.ts:24](https://github.com/brunohafonso95/linkedin-private-api/blob/466124d/src/repositories/message.repository.ts#L24)*
...
*Defined in [src/repositories/message.repository.ts:28](https://github.com/brunohafonso95/linkedin-private-api/blob/466124d/src/repositories/message.repository.ts#L28)*
