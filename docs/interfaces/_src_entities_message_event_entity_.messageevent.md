...
*Defined in [src/entities/message-event.entity.ts:6](https://github.com/stpoa/linkedin-private-api/blob/2f83b91/src/entities/message-event.entity.ts#L6)*
...
*Defined in [src/entities/message-event.entity.ts:5](https://github.com/stpoa/linkedin-private-api/blob/2f83b91/src/entities/message-event.entity.ts#L5)*
