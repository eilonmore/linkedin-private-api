...
*Defined in [src/entities/message-event.entity.ts:6](https://github.com/cosiall/linkedin-private-api/blob/bab5f17/src/entities/message-event.entity.ts#L6)*
...
*Defined in [src/entities/message-event.entity.ts:5](https://github.com/cosiall/linkedin-private-api/blob/bab5f17/src/entities/message-event.entity.ts#L5)*
