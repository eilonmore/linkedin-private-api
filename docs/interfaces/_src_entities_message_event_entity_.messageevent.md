...
*Defined in [src/entities/message-event.entity.ts:6](https://github.com/brunohafonso95/linkedin-private-api/blob/466124d/src/entities/message-event.entity.ts#L6)*
...
*Defined in [src/entities/message-event.entity.ts:5](https://github.com/brunohafonso95/linkedin-private-api/blob/466124d/src/entities/message-event.entity.ts#L5)*
