...
*Defined in [src/entities/linkedin-event.entity.ts:12](https://github.com/cosiall/linkedin-private-api/blob/288d758/src/entities/linkedin-event.entity.ts#L12)*
