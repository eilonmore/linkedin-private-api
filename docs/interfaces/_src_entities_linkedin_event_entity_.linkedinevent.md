...
*Defined in [src/entities/linkedin-event.entity.ts:12](https://github.com/cosiall/linkedin-private-api/blob/6982069/src/entities/linkedin-event.entity.ts#L12)*
