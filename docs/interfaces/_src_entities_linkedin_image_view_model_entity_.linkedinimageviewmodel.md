...
*Defined in [src/entities/linkedin-image-view-model.entity.ts:4](https://github.com/brunohafonso95/linkedin-private-api/blob/466124d/src/entities/linkedin-image-view-model.entity.ts#L4)*
...
*Defined in [src/entities/linkedin-image-view-model.entity.ts:5](https://github.com/brunohafonso95/linkedin-private-api/blob/466124d/src/entities/linkedin-image-view-model.entity.ts#L5)*
