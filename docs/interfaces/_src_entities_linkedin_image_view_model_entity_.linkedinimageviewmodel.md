...
*Defined in [src/entities/linkedin-image-view-model.entity.ts:4](https://github.com/cosiall/linkedin-private-api/blob/114c782/src/entities/linkedin-image-view-model.entity.ts#L4)*
...
*Defined in [src/entities/linkedin-image-view-model.entity.ts:5](https://github.com/cosiall/linkedin-private-api/blob/114c782/src/entities/linkedin-image-view-model.entity.ts#L5)*
