...
*Defined in [src/repositories/profile.repository.ts:20](https://github.com/cosiall/linkedin-private-api/blob/4854731/src/repositories/profile.repository.ts#L20)*
