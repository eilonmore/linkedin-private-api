...
*Defined in [src/entities/linkedin-event.entity.ts:1](https://github.com/cosiall/linkedin-private-api/blob/6982069/src/entities/linkedin-event.entity.ts#L1)*
...
*Defined in [src/entities/linkedin-event.entity.ts:3](https://github.com/cosiall/linkedin-private-api/blob/6982069/src/entities/linkedin-event.entity.ts#L3)*
